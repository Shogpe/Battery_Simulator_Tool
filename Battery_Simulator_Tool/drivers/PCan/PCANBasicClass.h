...
//
typedef TPCANStatus (
    *fpInitialize)(TPCANHandle, TPCANBaudrate, TPCANType, DWORD, WORD);
typedef TPCANStatus (*fpInitializeFD)(TPCANHandle, TPCANBitrateFD);
typedef TPCANStatus (*fpOneParam)(TPCANHandle);
typedef TPCANStatus (*fpRead)(TPCANHandle, TPCANMsg*, TPCANTimestamp*);
typedef TPCANStatus (*fpReadFD)(TPCANHandle, TPCANMsgFD*, TPCANTimestampFD*);
typedef TPCANStatus (*fpWrite)(TPCANHandle, TPCANMsg*);
typedef TPCANStatus (*fpWriteFD)(TPCANHandle, TPCANMsgFD*);
typedef TPCANStatus (*fpFilterMessages)(TPCANHandle, DWORD, DWORD, TPCANMode);
typedef TPCANStatus (*fpGetSetValue)(TPCANHandle, TPCANParameter, void*, DWORD);
typedef TPCANStatus (*fpGetErrorText)(TPCANStatus, WORD, LPSTR);
...
class PCANBasicClass {
 ...
 public:
  ...
  /// code)"</param> <param name="HwType">"NON PLUG&PLAY: The type of hardware
  /// and operation mode"</param> <param name="IOPort">"NON PLUG&PLAY: The I/O
  /// address for the parallel port"</param> <param name="Interupt">"NON
  /// PLUG&PLAY: Interrupt number of the parallel port"</param> <returns>"A
  /// TPCANStatus error code"</returns>
  TPCANStatus Initialize(TPCANHandle Channel,
  ...
  /// <param name="BitrateFD">"The speed for the communication (FD Bitrate
  ...
  /// TPCANStatus error code"</returns>
  TPCANStatus Read(TPCANHandle Channel,
  ...
  /// </summary>
  /// <param name="Channel">"The handle of a FD capable PCAN Channel"</param>
  /// <param name="MessageBuffer">"A TPCANMsgFD structure buffer to store the
  /// CAN message"</param> <param name="TimestampBuffer">"A TPCANTimestampFD
  /// buffer to get the reception time of the message. If this value is not
  /// desired, this parameter should be passed as NULL"</param> <returns>"A
  /// TPCANStatus error code"</returns>
  TPCANStatus ReadFD(TPCANHandle Channel,
  ...
  /// <returns>"A TPCANStatus error code"</returns>
  TPCANStatus FilterMessages(TPCANHandle Channel,
                             DWORD FromID,
                             DWORD ToID,
                             TPCANMode Mode);
  ...
  /// <returns>"A TPCANStatus error code"</returns>
  TPCANStatus GetValue(TPCANHandle Channel,
  ...
  /// <param name="BufferLength">"Size in bytes of the buffer"</param>
  /// <returns>"A TPCANStatus error code"</returns>
  TPCANStatus SetValue(TPCANHandle Channel,
                       TPCANParameter Parameter,
                       void* Buffer,
                       DWORD BufferLength);
