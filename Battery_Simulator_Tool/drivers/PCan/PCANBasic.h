...
#define PCAN_ERROR_XMTFULL \
  0x00001U  // Transmit buffer in CAN controller is full
...
#define PCAN_ERROR_REGTEST \
  0x00100U  // Test of the CAN controller hardware registers failed (no hardware
            // found)
...
#define PCAN_ERROR_NETINUSE \
  0x00800U                          // A Client is already connected to the Net
...
#define PCAN_IO_DIGITAL_CONFIGURATION \
  0x24U  // Output mode of 32 digital I/O pin of a PCAN-USB Chip. 1:
         // Output-Active 0 : Output Inactive
#define PCAN_IO_DIGITAL_VALUE \
  0x25U  // Value assigned to a 32 digital I/O pins of a PCAN-USB Chip
#define PCAN_IO_DIGITAL_SET \
  0x26U  // Value assigned to a 32 digital I/O pins of a PCAN-USB Chip -
         // Multiple digital I/O pins to 1 = High
...
#define PCAN_CHANNEL_PCANVIEW \
  (PCAN_CHANNEL_AVAILABLE |   \
   PCAN_CHANNEL_OCCUPIED)  // The PCAN-Channel handle is already being used
                           // by a PCAN-View application, but is available to
                           // connect
...
#define FEATURE_IO_CAPABLE \
  0x04U  // Device supports I/O functionality for electronic circuits (USB-Chip
         // devices)
...
#define TPCANType \
  BYTE  // Represents the type of PCAN hardware to be initialized
...
#define TPCANTimestampFD \
  UINT64  // Represents a timestamp of a received PCAN FD message
...
// Total Microseconds = micros + 1000 * millis + 0x100000000 * 1000 *
// millis_overflow
//
...
/// <param name="Btr0Btr1">"The speed for the communication (BTR0BTR1
/// code)"</param> <param name="HwType">"NON PLUG&PLAY: The type of hardware and
/// operation mode"</param> <param name="IOPort">"NON PLUG&PLAY: The I/O address
/// for the parallel port"</param> <param name="Interrupt">"NON PLUG&PLAY:
/// Interrupt number of the parallel port"</param> <returns>"A TPCANStatus error
/// code"</returns>
...
/// <param name="BitrateFD">"The speed for the communication (FD bit rate
/// string)"</param> <remarks>See PCAN_BR_* values
/// * Parameter and values must be separated by '='
/// * Couples of Parameter/value must be separated by ','
/// * Following Parameter must be filled out: f_clock, data_brp, data_sjw,
/// data_tseg1, data_tseg2,
...
TPCANStatus __stdcall CAN_InitializeFD(TPCANHandle Channel,
...
/// </summary>
/// <param name="Channel">"The handle of a PCAN Channel"</param>
/// <param name="MessageBuffer">"A TPCANMsg structure buffer to store the CAN
/// message"</param> <param name="TimestampBuffer">"A TPCANTimestamp structure
/// buffer to get the reception time of the message. If this value is not
/// desired, this parameter should be passed as NULL"</param> <returns>"A
/// TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_Read(TPCANHandle Channel,
...
/// </summary>
/// <param name="Channel">"The handle of a FD capable PCAN Channel"</param>
/// <param name="MessageBuffer">"A TPCANMsgFD structure buffer to store the CAN
/// message"</param> <param name="TimestampBuffer">"A TPCANTimestampFD buffer to
/// get the reception time of the message. If this value is not desired, this
/// parameter should be passed as NULL"</param> <returns>"A TPCANStatus error
/// code"</returns>
TPCANStatus __stdcall CAN_ReadFD(TPCANHandle Channel,
...
/// </summary>
/// <param name="Channel">"The handle of a PCAN Channel"</param>
/// <param name="MessageBuffer">"A TPCANMsg buffer with the message to be
/// sent"</param> <returns>"A TPCANStatus error code"</returns>
...
/// </summary>
/// <param name="Channel">"The handle of a FD capable PCAN Channel"</param>
/// <param name="MessageBuffer">"A TPCANMsgFD buffer with the message to be
/// sent"</param> <returns>"A TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_WriteFD(TPCANHandle Channel,
                                  TPCANMsgFD* MessageBuffer);
...
/// <returns>"A TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_FilterMessages(TPCANHandle Channel,
                                         DWORD FromID,
                                         DWORD ToID,
                                         TPCANMode Mode);
...
/// <returns>"A TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_GetValue(TPCANHandle Channel,
...
/// <param name="BufferLength">"Size in bytes of the buffer"</param>
/// <returns>"A TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_SetValue(TPCANHandle Channel,
                                   TPCANParameter Parameter,
                                   void* Buffer,
                                   DWORD BufferLength);
...
/// <returns>"A TPCANStatus error code"</returns>
TPCANStatus __stdcall CAN_GetErrorText(TPCANStatus Error,
                                       WORD Language,
                                       LPSTR Buffer);
